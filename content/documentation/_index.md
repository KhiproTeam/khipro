...
ক্ষিপ্র [৩৬তম সংস্করণ](https://github.com/rank-coder/khipro-m17n/releases): (তারিখ পরে লেখা হবে)
...
## ১.১ পৃথায়ক ও মডিফায়ার এর ফাংশন

### ১.১.১ পৃথায়ক

- ক্ষিপ্র-তে সেমিকোলন `;` হলো পৃথায়ক।

- পৃথায়ক ব্যবহার করে লেখাকে ছিন্নায়িত বা অংশায়িত করা যায়।  
...
- পৃথায়ককে [যুক্তবর্ণ গঠন রোধ]() করতেও ব্যবহার করা যায়। যেমন:  
`বুধবার` = `budh;bar`  
তবে যদি সম্ভাব্য যুক্তবর্ণ না থাকে তাহলে পৃথায়ক দেওয়া লাগবে না। যেমন:  
`লিখতে` = `likhte`  
- একটা শব্দে যতবার ইচ্ছা পৃথায়ক ব্যবহার করা যাবে।
...
ক্ষিপ্রতে একাধিক মডিফায়ার key রয়েছে। একটি হলো `f` যাকে প্রয়োজনে `⁌` রূপে দেখানো হয়; আরেকটি হলো **স্ল্যাশ** `/`, এবং অপরটি হলো **ব্যাকস্ল্যাশ**।
...
এছাড়া [চন্দ্রবিন্দু লেখার]() জন্যেও স্ল্যাশ ব্যবহার করা যায়।
...
### ব্যাকস্ল্যাশ (\\) ও ব্লাইন্ডার
ব্যাকস্ল্যাশ বাটনকে [ব্লাইন্ডার (blinder)]() হিসেবে ব্যবহার করা হয়। এটি দিয়ে সাময়িকভাবে ক্ষিপ্র-কে সুপ্ত রাখা যায়। বিস্তারিত আলোচনা [নিচে]()। 

## ১.২ কারচিহ্ন ও স্বরবর্ণ লেখা
### ১.২.১ সাধারণ স্বরবর্ণের তালিকা
...
> [!NOTE] অ ব্যতীত অন্যান্য স্বরবর্ণকে কারচিহ্ন বানানো যাবে। অ-এর কোনো কারচিহ্ন নেই। তাই `of`= `ঽ`  ([অবগ্রহ]()) ম্যাপ করা হয়েছে।

### ১.২.২ অতিরিক্ত স্বরবর্ণের তালিকা
...
### ১.২.৩ স্বচ্ছ রূপের কারচিহ্ন লেখা (শু / শ‌ু)

বেশ কিছু ফন্টে স্বরচিহ্ন অস্বচ্ছ রূপে লেখা হয়। যেমন: রু, রূ, হৃ ইত্যাদি। এসব ক্ষেত্রে কারচিহ্ন নিচে না বসে ডানপাশে বিশেষ রূপে এসেছে। এসব ক্ষেত্রে স্বাভাবিক নিয়মে কারচিহ্নগুলো লিখলে সেগুলো ফন্টের কারণেই অস্বচ্ছ রূপে আসবে।  
স্বচ্ছ রূপে লেখার জন্য কারচিহ্নের আগে ZWNJ ব্যবহার করতে হয়। এই কাজটি সহজে করার জন্য ক্ষিপ্র-তে বিশেষ ব্যবস্থা রাখা হয়েছে।
...
- একই উপায়ে শব্দের মাঝেও এই কাজ করা যাবে।

### ১.২.৪ চন্দ্রবিন্দু লেখা
চন্দ্রবিন্দু স্বরধ্বনির সাথে সম্পর্কিত বলে এখানে আলোচিত হচ্ছে।  
- স্বরধ্বনির পরে স্ল্যাশ ব্যবহার করলে চন্দ্রবিন্দু আসবে। (এক্ষেত্রে স্ল্যাশ, [মডিফায়ার]() হিসেবে কাজ করবে।) যেমন:  
  `ma/` = `মাঁ`
  `po/` = `পঁ`
  `p/` = `প/`
- কোথাও মুক্ত অবস্থায় কিংবা নতুন করে চন্দ্রবিন্দু বসাতে হলে দুটি স্ল্যাশ দিতে হবে। যেমন:  
  `//` = `ঁ`

## ১.৩ ব্যঞ্জনবর্ণ সংক্রান্ত

### ১.৩.১ সাধারণ ব্যঞ্জনবর্ণ লেখা
...
- ঞ প্রায় সবসময়ই যুক্তবর্ণ রূপে আসে। সেক্ষেত্রে শুধু n দিয়েই ঞ লেখা যাবে। যেমন:  
   `ঞ্চ` \= `nc` \[`পঞ্চাশ` \= `poncash`\]  
   `ঞ্জ` \= `nj` \[`ব্যঞ্জন` \= `bznjon`\]  
   ইত্যাদি।  
- ঞ মুক্তভাবে আসলে nff দিয়ে লিখতে হবে। যেমন:  
   `ঞ` \= `nff` \[`মিঞা` \= `minffa`\]  
- ঞ কে মুক্তভাবে লেখার আরেকটি উপায় হলো `mf`  
  `mf` -> `ঞ`  
- বলা বাহুল্য, চাইলে `nff` এবং `mf` দিয়েও যুক্তবর্ণে ঞ লেখা যাবে। যেমন:  
  `nffc` = `ঞ্চ` &nbsp; `mfc` = `ঞ্চ`
...
1. [khipro-library](https://github.com/KhiproTeam/khipro-library) (ক্ষিপ্র লাইব্রেরি) ব্যবহার করে ডেভেলপারগণ তাঁদের কিবোর্ডে ক্ষিপ্র ইমপ্লিমেন্ট করতে পারেন।
...
> টাচস্ক্রিনের এই সকল পরিবর্তন অনুসারে `khipro-m17n`-এর একটি টাচস্ক্রিন সংস্করণ প্রকাশ করা হয়েছে। টাচস্ক্রিন সংস্করণটি এখানে পাওয়া যাবে: [khipro-mim-touchscreen](https://github.com/KhiproTeam/khipro-mim-touchscreen)