...
- আমরা জানি, পূর্বে লেখা কোনো বর্ণের সাথে নতুন করে কারচিহ্ন যোগ করতে স্বরের পরে [মডিফায়ার]() f ব্যবহার করা হয়। যেমন:  
   `া` \= `af`   
   স্বচ্ছ রূপের কারচিহ্নগুলোও নতুন করে যুক্ত করা যাবে। যেমন:  
  ` ু` \= `uf` &emsp; 		`ZWNJ + ু` \= `uff`
